...
export const AnalyticsHeader = ({
  ...
  <header className="px-6 pt-12 pb-6 shrink-0 bg-transparent relative z-20">
    ...
    >
      <p className="text-[#B87333]/70 text-[10px] font-black uppercase tracking-[0.3em] mb-1">Analisar</p>
      <h2 className="text-4xl font-black text-[#F7EFE2] tracking-tighter leading-none mb-8">Faturamento</h2>
    </motion.div>
        ...
        return (
          <button
            ...
            className={`flex-1 relative py-3 rounded-xl text-[10px] font-black uppercase tracking-[0.15em] transition-colors duration-300 z-10 ${
              isActive ? "text-[#F7EFE2]" : "text-zinc-600 hover:text-zinc-400"
            }`}
          >
            {t}
            {isActive && (
              <motion.div
                ...
                className="absolute inset-0 bg-[#B87333] rounded-xl shadow-[0_5px_15px_rgba(184,115,51,0.3)] -z-10"
    ...
    <div className="flex items-center justify-between bg-zinc-900/50 border border-zinc-800 rounded-[1.5rem] p-2">
      <motion.button
        ...
        className="w-11 h-11 flex items-center justify-center text-zinc-500 hover:text-[#F7EFE2] bg-zinc-800 rounded-xl transition-all will-change-transform"
      >
      ...
      <div className="flex flex-col items-center">
        <span className="text-[11px] font-black uppercase tracking-tighter text-[#F7EFE2]">
          {periodLabel}
        </span>
      </div>
