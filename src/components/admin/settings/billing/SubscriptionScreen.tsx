...
export function SubscriptionSection() {
  ...
  return (
    <>
      {/* Se for PRO, mostra o painel importado. Se for FREE, mostra o banner de upgrade. */}
      {isPlanActive ? (
        ...
        <div className="relative overflow-hidden bg-zinc-900/40 border border-zinc-800 rounded-[2.5rem] p-8 group">
          <div className="absolute -right-10 -top-10 w-32 h-32 bg-[#B87333]/10 blur-[50px] rounded-full group-hover:bg-[#B87333]/20 transition-all duration-700 pointer-events-none" />
          ...
          <div className="relative z-10 flex flex-col items-center text-center">
            ...
            >
              <Image
                ...
                alt="Foguete"
                fill
                className="object-contain drop-shadow-[0_10px_20px_rgba(184,115,51,0.3)]"
              />
            </motion.div>

            <h3 className="text-xl font-black text-white tracking-tight mb-2">
              Leve sua barbearia para o <span className="text-[#C88A52]">próximo nível</span>
            </h3>
            ...
            <button
              ...
              disabled={loading}
              className="w-full bg-[#B87333] text-[#F7EFE2] py-4 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-lg shadow-[#B87333]/20 hover:bg-[#C88A52] transition-all active:scale-[0.98] disabled:opacity-50"
            >
              Fazer Upgrade Agora
            </button>
            ...
            <div className="mt-4 flex flex-col items-center min-h-[14px]">
              <p className="text-[10px] font-bold text-zinc-600 uppercase tracking-widest">
                Período de teste: <span className="text-[#B87333]">
