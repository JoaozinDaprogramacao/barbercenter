    ...
    <div className="w-full">
      ...
      <div className="flex justify-between items-end px-5 pb-3 border-b border-zinc-900">
        ...
        <button
          ...
          disabled={isSaving}
          className={`text-sm font-bold ${isEditing ? 'text-green-500' : 'text-[#D49A62]'} active:opacity-50 transition-all`}
        >
          {isSaving ? <Loader2 size={16} className="animate-spin" /> : isEditing ? "Concluir" : "Alterar"}
        </button>
      </div>
