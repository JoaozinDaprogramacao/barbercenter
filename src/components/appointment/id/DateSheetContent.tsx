    ...
    return (
        <div className="flex flex-col gap-y-8 py-4">
            <div className="space-y-2">
                ...
                <h3 className="text-3xl font-black text-[#F7EFE2] tracking-tighter">Novo Horário</h3>
            </div>
            ...
            {date && (
                <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                    <div className="flex items-center gap-4">
                        ...
                        <span className="text-[10px] font-black text-[#F7EFE2]/30 uppercase tracking-widest flex items-center gap-2">
