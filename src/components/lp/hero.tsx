      ...
      <div className="max-w-screen-2xl mx-auto px-6 md:px-12 pt-12 md:pt-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
        ...
        <div className="pb-8 md:pb-24">
          ...
          <div className="mt-8 md:mt-10 flex flex-col sm:flex-row gap-4">
            <button className="w-full sm:w-auto justify-center bg-black text-white px-8 py-4 rounded-2xl flex items-center space-x-3 hover:opacity-80 transition shadow-xl shadow-slate-200">
              <Smartphone size={22} />
        ...
        <div className="hidden md:flex relative justify-center h-full min-h-[600px]">
          <div className="relative z-10 w-[380px] h-[700px] lg:h-[780px] lg:-mt-32 bg-slate-900 rounded-3xl border-[6px] border-black shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] overflow-hidden transform translate-y-[20%]">
            <div className="absolute top-0 left-0 w-full h-14 flex items-center justify-between px-8 z-20 pointer-events-none">
              ...
              <div className="w-16 flex items-center justify-end space-x-1.5 text-white">
                <svg className="w-[16px] h-[12px]" viewBox="0 0 18 12" fill="currentColor">
                  <rect x="1" y="8" width="3" height="4" rx="1"/>
                  <rect x="5.5" y="5" width="3" height="7" rx="1"/>
                  <rect x="10" y="2" width="3" height="10" rx="1"/>
                  <rect x="14.5" y="0" width="3" height="12" rx="1"/>
                </svg>
                <svg className="w-[16px] h-[12px]" viewBox="0 0 16 12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M1.5 5.5C4.5 2.5 11.5 2.5 14.5 5.5M4 8C6 6 10 6 12 8M8 11.5v.01" />
                </svg>
                <svg className="w-[24px] h-[12px]" viewBox="0 0 25 12" fill="none">
          ...
          <div className="absolute top-20 -right-4 bg-white p-5 rounded-2xl shadow-2xl z-20 border border-slate-100 animate-bounce-slow origin-right">
          ...
          <div className="absolute top-1/2 -left-8 bg-white p-5 rounded-2xl shadow-2xl z-20 border border-slate-100 origin-left">
